...
const SouthAmericaDestinationsPage = () => {
  useDocumentTitle("South America Destinations");
    ...
    <DestinationsPageLayout
      ...
      description={
        <p className="text-center text-lg sm:text-xl text-muted-foreground">
          From the vibrant rhythms of Rio de Janeiro to the ancient mysteries of
          Machu Picchu, South America offers incredible diversity, rich
          cultures, and breathtaking landscapes. Experience the warmth of Latin
          American hospitality, world-class cuisine, and unforgettable
          adventures across this magnificent continent.
        </p>
      }
