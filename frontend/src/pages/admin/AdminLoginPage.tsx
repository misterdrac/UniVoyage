  ...
  if (user && user.role !== "ADMIN" && user.role !== "HEAD_ADMIN") {
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom right, var(--admin-decorative-emerald), var(--admin-decorative-teal), var(--background))",
        }}
      >
        <div className="max-w-md w-full bg-card/95 backdrop-blur-xl rounded-3xl shadow-2xl border p-8 text-center">
          <div
            className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6"
            style={{ backgroundColor: "var(--admin-badge-admin-bg)" }}
          >
            <Shield
              className="w-10 h-10"
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, var(--admin-overlay-start), var(--admin-overlay-end), transparent)",
          }}
        />
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 max-w-xl">
          <div className="flex items-center gap-3 mb-6">
            <div
              ...
              style={{
                backgroundColor:
                  "color-mix(in srgb, var(--ds-contrast-fg) 20%, transparent)",
              }}
            >
              <Shield
                className="w-7 h-7"
          ...
          <p
            ...
            style={{
              color:
                "color-mix(in srgb, var(--ds-contrast-fg) 90%, transparent)",
            }}
          >
            Manage users, destinations, and content for the UniVoyage travel
            platform.
          </p>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                style={{
                  ...
                  boxShadow:
                    "0 10px 15px -3px rgba(16, 185, 129, 0.25), 0 4px 6px -4px rgba(16, 185, 129, 0.25)",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.background =
                    "linear-gradient(to right, var(--admin-gradient-start-hover), var(--admin-gradient-end-hover))";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background =
                    "linear-gradient(to right, var(--admin-gradient-start), var(--admin-gradient-end))";
