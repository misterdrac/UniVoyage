...
const DESTINATION_TABLE_COLUMNS: {
  field: DestinationSortField;
  label: string;
}[] = [
...
const AdminDestinationsPage: React.FC = () => {
  ...
  const [formData, setFormData] =
    useState<CreateDestinationRequest>(EMPTY_FORM);
  ...
  const handleSaveChanges = async () => {
    if (
      ...
      toast.error(
        "Name, country, continent, and country code are required (pick a valid country from the list)",
      );
      return;
    }
    ...
    try {
      if (isCreating) {
        ...
        const updatedDestination = await apiService.updateDestination(
  ...
  const updateField = <K extends keyof CreateDestinationRequest>(
    field: K,
    value: CreateDestinationRequest[K],
  ) => {
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center">
                            <span
                              ...
                              style={{
                                backgroundColor:
                                  "var(--admin-decorative-emerald)",
                                color: "var(--admin-gradient-start)",
                              }}
                            >
                              {destination.continent}
                            </span>
                          </td>
                          <td className="px-4 py-3 text-sm text-foreground whitespace-nowrap text-center">
              ...
              <div className="px-6 pb-6 overflow-y-auto dropdown-scrollbar flex-1 min-h-0">
                <div className="space-y-5">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          For a destination to appear as a card on the
                          destination pages, it must have an{" "}
                          <strong className="text-foreground">Image URL</strong>
                          ,{" "}
                  ...
                  <div className="space-y-2">
                    ...
                    <AutoComplete
                      ...
                      onBlur={() => {
                        ...
                        if (
                          formData.continent &&
                          !CONTINENTS.includes(formData.continent)
                        ) {
                  ...
                  <TextAreaField
                    ...
                    onChange={(v) => updateField("whyVisit", v)}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-3">
                      <Input
                        ...
                        onKeyDown={(e) =>
                          e.key === "Enter" &&
                          (e.preventDefault(), handleAddPerk())
                        }
                      ...
                      <div className="flex justify-center">
                        <Button
                          ...
                          disabled={
                            currentPerksCount >= MAX_PERKS || !newPerk.trim()
                          }
                          className="gap-1"
                        >
                          <Plus className="w-4 h-4" />
