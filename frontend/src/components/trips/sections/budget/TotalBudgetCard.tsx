      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              className={cn(
                "p-3 rounded-lg bg-primary/10 border-primary/30 border",
              )}
            >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div
            ...
            style={{
              backgroundColor:
                "color-mix(in oklch, var(--spent) 10%, transparent)",
          ...
          >
            ...
            {totalBudget > 0 && (
              <p className="text-xs text-muted-foreground mt-1">
                {((totals.actualTotal / totalBudget) * 100).toFixed(0)}% of
                budget
              </p>
            )}
          </div>
          ...
          >
            ...
            <p
              ...
              style={
                remainingBudget >= 0 ? { color: "var(--success)" } : undefined
              }
            >
        ...
        {totalBudget > 0 && (
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              ...
              <span>
                {((totals.actualTotal / totalBudget) * 100).toFixed(0)}%
              </span>
            </div>
