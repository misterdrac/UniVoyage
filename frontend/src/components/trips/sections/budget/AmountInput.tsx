...
export function AmountInput({
  ...
  return (
    <div className="relative">
      <span className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 text-muted-foreground z-10 text-sm sm:text-base">
        $
      </span>
      <Input
        id={id}
      ...
      <div className="absolute right-0.5 sm:right-1 top-1/2 -translate-y-1/2 flex flex-col gap-0">
        <Button
          ...
          onClick={() => onChange(parseFloat(((value || 0) + 1.0).toFixed(2)))}
        >
        ...
        <Button
          ...
          onClick={() =>
            onChange(Math.max(0, parseFloat(((value || 0) - 1.0).toFixed(2))))
          }
        >
