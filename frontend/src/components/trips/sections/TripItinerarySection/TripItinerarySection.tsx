    ...
    <div className="space-y-6">
      <div className="rounded-2xl border bg-card/60 p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Plan your days with an AI-powered itinerary tailored to your
          interests.
        </p>
      </div>
      ...
      {!structuredItinerary && rawItinerary && (
        <RawItineraryDebug raw={rawItinerary} />
      )}
      ...
      {!hasExistingPlan && !isLoading && (
        <div className="rounded-2xl border border-dashed bg-muted/20 p-6 text-center">
          ...
          <p className="mt-3 text-sm font-semibold text-foreground">
            No plan yet—let’s storyboard it.
          </p>
          <p className="mt-1 text-sm text-muted-foreground">
            Once generated, you’ll get a cinematic timeline full of standout
            meals, mindful pauses, and night stories.
          </p>
        </div>
      )}
    </div>
