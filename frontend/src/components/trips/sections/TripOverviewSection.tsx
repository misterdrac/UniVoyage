...
const getCountdownToDepartureStart = (
...
export function TripOverviewSection({
  ...
  const budgetPercentage =
    totalBudget > 0 ? (totals.actualTotal / totalBudget) * 100 : 0;
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground leading-relaxed text-base">
          This is your trip to {trip.destinationName},{" "}
          {trip.destinationLocation}. Your journey begins on{" "}
          {formatDateLong(trip.departureDate)} and concludes on{" "}
      ...
      <div>
        ...
        <div className="space-y-4">
          {currentStatus === "planned" && (
            <DepartureCountdownCard departureDate={trip.departureDate} />
          )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {formatCurrency(totals.actualTotal)} of{" "}
              ...
              <div className="flex items-center gap-2 pt-1">
                {remainingBudget < 0 ? (
                  ...
                  <>
                    ...
                    <span className="text-xs var(--profile-stat-amber) font-medium">
                      Almost spent
                    </span>
                  </>
                ) : (
      ...
      <div>
        ...
        <p className="text-muted-foreground leading-relaxed text-base">
          Use the navigation tabs above to explore different sections of your
          trip. You can manage your budget, view accommodation details, discover
          places to visit, check the map, see weather forecasts, and plan your
          itinerary.
        </p>
      </div>
    </div>
