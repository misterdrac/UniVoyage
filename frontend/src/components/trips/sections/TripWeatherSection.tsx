...
export function TripWeatherSection({
  ...
  const [packingForecast, setPackingForecast] = useState<ForecastDay[] | null>(
    null,
  );
          ...
          <Card className="p-6 border-2 border-dashed">
            <CardContent className="p-0">
              <p className="text-sm text-muted-foreground text-center">
                💡 <strong>Tip:</strong> Weather forecasts are most accurate
                within 5 days. Check back closer to your trip for the most
