    ...
    <div className="flex flex-col items-center gap-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground text-sm max-w-md mx-auto">
          Add your accommodation details now or skip and fill them in later. All
          fields are optional.
        </p>
      </div>
      ...
      <div className="w-full max-w-md space-y-5">
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("accommodationName", e.target.value)
              }
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("accommodationAddress", e.target.value)
              }
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange("accommodationPhone", e.target.value)
              }
        ...
        <div className="rounded-xl border border-dashed border-border bg-muted/30 p-4">
          <p className="text-xs text-muted-foreground text-center">
            Don't have these details yet? No worries — you can add or update
            accommodation info from your trip page anytime.
          </p>
        </div>
      </div>
    </div>
