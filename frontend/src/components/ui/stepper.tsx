      ...
      >
        <div
          ...
          className={cn(
            ...
            isVertical
              ? "flex-col"
              : "flex-row flex-wrap justify-center sm:flex-nowrap sm:justify-between",
            variant === "line" && "gap-0",
  ...
  (props, ref) => {
    ...
    return (
      <div
        ...
        onClick={() => {
          if (onClickStep) onClickStep(index || 0, setStep, activeStep);
          else onClickStepGeneral?.(index || 0, setStep, activeStep);
        }}
      >
        <div
          data-vertical
