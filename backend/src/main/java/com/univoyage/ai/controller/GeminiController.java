...
/**
 * Controller for AI-related functionalities using Gemini. Provides endpoints
 * for generating travel itineraries and packing suggestions. All endpoints are
 * prefixed with /api/ai. Uses GeminiService for business logic. Returns
 * responses wrapped in ApiResponse for consistent API structure.
 */
@RestController
