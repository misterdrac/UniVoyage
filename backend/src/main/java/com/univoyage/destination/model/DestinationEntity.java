 ...
 */
@Entity
@Table(name = "destinations", uniqueConstraints = @UniqueConstraint(name = "uq_destinations_title_location", columnNames = {
    "title", "location"}))
@Getter
@Setter
@NoArgsConstructor
...
public class DestinationEntity {
  ...
  /**
   * Rolling average from trip_traveller_ratings for this destination (separate
   * from admin average_rating).
   */
