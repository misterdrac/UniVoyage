...
public interface UserIdentityService {
     ...
     * @param providerSubject immutable subject ID from the provider
     * @param providerEmail   email returned by the provider (may be null)
     * @param emailVerified   whether the provider has verified that email
     ...
     */
    UserIdentity createIdentity(UserEntity user,
                                String provider,
    ...
    /**
     * Find an existing identity by provider + subject.
     * Returns empty when the subject has never signed in via this provider.
     */
     ...
     * Useful for account-management and linking-status checks.
     */
