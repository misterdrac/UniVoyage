 ...
 * Implements Spring Security's UserDetailsService interface. Retrieves user
 * information from UserRepository. Throws UsernameNotFoundException if user is
 * not found.
 */
@Service
...
public class CustomUserDetailsService implements UserDetailsService {
  ...
  /**
   * Load user details by user ID string. Parses user ID from string to Long.
