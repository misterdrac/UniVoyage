...
public interface UserIdentityRepository extends JpaRepository<UserIdentity, Long> {
  ...
  /**
   * Look up an existing identity by provider + provider-issued subject. Returns
   * empty when this is the first sign-in for that subject.
   */
  ...
  /**
   * Check whether a specific (provider, subject) pair is already linked. Useful
   * for guard checks without loading the full entity.
   */
